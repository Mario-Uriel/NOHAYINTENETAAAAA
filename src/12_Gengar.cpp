...
{
    // Crear una ventana
    sf::RenderWindow window(sf::VideoMode({800, 600}), "Gengar Sprite Animado");

    // Cargar la imagen Gengar desde un archivo
    sf::Texture texture;
    if (!texture.loadFromFile("assets/images/Gengar.png"))
    {
