...
{
    // Crear una ventana
    sf::RenderWindow window(sf::VideoMode({800, 600}), "SFML - Bala Armas");

    // Cargar la imagen de la bala de armas desde un archivo
    sf::Texture texture;
    if (!texture.loadFromFile("./assets/images/Bala Armas .png"))
    {
