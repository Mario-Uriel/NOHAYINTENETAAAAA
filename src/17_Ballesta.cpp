...
{
    // Crear una ventana
    sf::RenderWindow window(sf::VideoMode({800, 600}), "Ballesta Sprite Animado");

    // Cargar la imagen Ballesta desde un archivo
    sf::Texture texture;
    if (!texture.loadFromFile("assets/images/Ballesta .png"))
    {
